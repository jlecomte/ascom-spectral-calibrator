...
#define MyAppName "Spectral Calibrator ASCOM Driver"
#define MyAppVersion "1.2.1"
#define MyAppURL "https://github.com/jlecomte/ascom-spectral-calibrator"

[Setup]
AppId={{B4289A31-0D83-4C54-BA2D-6C13FCCE4441}
...
SourceDir="C:\Users\Julien\source\repos\ascom-spectral-calibrator"
OutputDir="Installer"
...
[Files]
Source: "ASCOM_Driver\bin\Release\ASCOM.DarkSkyGeek.SpectralCalibrator.dll"; DestDir: "{app}"
Source: "ASCOM_Client\calibrator.py"; DestDir: "{app}"

[Run]
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.DarkSkyGeek.SpectralCalibrator.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.DarkSkyGeek.SpectralCalibrator.dll"""; Flags: runhidden 64bit; Check: IsWin64

[UninstallRun]
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.DarkSkyGeek.SpectralCalibrator.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.DarkSkyGeek.SpectralCalibrator.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.DarkSkyGeek.SpectralCalibrator.dll"""; Flags: runhidden 64bit; Check: IsWin64
