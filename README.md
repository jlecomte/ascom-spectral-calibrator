...
:warning: **IMPORTANT:** :warning: This project is no longer actively maintained. Instead, check out [my new Telescope Cover V2](https://github.com/jlecomte/ascom-telescope-cover-v2), which neatly incorporates a spectral calibrator.
